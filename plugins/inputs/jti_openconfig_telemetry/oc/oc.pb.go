...
type SubscriptionReply struct {
	// ResponseBody message to a telemetry subscription creation or
	// get request.
...
// ResponseBody message to a telemetry subscription creation or get request.
...
type OpenConfigTelemetryClient interface {
	// RequestBody an inline subscription for data at the specified path.
